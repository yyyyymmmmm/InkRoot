...
class AppTypography {
  ...
  static const double _baseTitleMedium = 15; // 16→15（微信标准）
  static const double _baseTitleSmall = 13; // 14→13
  static const double _baseLabelLarge = 13; // 14→13
  static const double _baseLabelMedium = 11; // 12→11
  static const double _baseLabelSmall = 10; // 11→10
  static const double _baseBodyLarge = 15; // 16→15（微信标准正文）
  static const double _baseBodyMedium = 13; // 14→13
  static const double _baseBodySmall = 11; // 12→11
