      ...
      if (response.statusCode == 200) {
        ...
        if ((data['resultCount'] as int? ?? 0) > 0) {
          ...
          return AppStoreVersionInfo(
            ...
            releaseNotes: appInfo['releaseNotes'] as String? ?? '',
            trackViewUrl: appInfo['trackViewUrl'] as String? ?? '',
            currentVersionReleaseDate:
                appInfo['currentVersionReleaseDate'] as String? ?? '',
          );
        }
      }
        ...
        builder: (context) => AlertDialog(
          title: Row(
            children: [
              ...
              Text(
                AppLocalizationsSimple.of(context)?.newVersionAvailable ??
                    '发现新版本',
              ),
            ],
          ),
          content: Column(
            ...
            children: [
              ...
              if (versionInfo.releaseNotes.isNotEmpty) ...[
                Text(
                  AppLocalizationsSimple.of(context)?.updateNotes ?? '更新内容：',
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 14,
                  ),
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text(AppLocalizationsSimple.of(context)?.later ?? '稍后'),
            ),
            FilledButton(
              onPressed: () {
              ...
              child: Text(
                AppLocalizationsSimple.of(context)?.goToUpdate ?? '前往更新',
              ),
            ),
          ],
        ),
