...
5. When changing shared CSS, publish a new versioned CSS file and update page references. The production site is behind CDN caching, so changing only `assets/css/site.css` can leave users with new HTML and old CSS.
6. Keep the real site identity information:
